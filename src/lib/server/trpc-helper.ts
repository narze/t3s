// trpc-helper.ts
import type { Router as AppRouter } from './trpc'; // Import AppRouter from your main server router
import type {
...
export type InferQueries = AppRouter['_def']['queries'];
export type InferQuery<TRouteKey extends TQuery> = InferQueries[TRouteKey];
